...
import com.my.mobilesafe.service.LockScreenService;
...
public class ProcessSettingActivity extends myActivity {
	...
	private void initLockScreenClear() {
		...
		boolean isRunning = ServiceUtil.isRunning(this, "com.my.mobilesafe.service.LockScreenService");
		if(isRunning){
